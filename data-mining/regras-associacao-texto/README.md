...
- `work4b.html` - Versão alternativa HTML
...
```bash
pip install pandas numpy mlxtend nltk matplotlib seaborn
```

2. Baixe os dados do NLTK (se necessário):
```python
import nltk
nltk.download('punkt')
...
- **Visualização:** Gráficos de regras de associação
